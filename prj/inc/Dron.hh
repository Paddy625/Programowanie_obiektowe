...
class Dron : public ObiektSceny {
  ...
  */
  ...
  /*!
  * \brief Metoda zwraca zawartosc katu obrotu
  * 
  * Metoda zwraca zawartosc kata obrotu
  * \return double - kat obrotu
  */
  double ZwrocKat() { return Kat_Obrotu;}
  /*!
   ...
   * \param wek - wektor o jaki ma wykonac sie ruch
   */
   ...
   * \param Lacze - lacze do programu GNUPlot przez ktore ma byc rysowany dron
   * \param NumerDrona - numer obracanego drona
   */
   ...
   * \param Lacze - lacze do programu GNUPlot przez ktore ma byc rysowany dron
   * \param NumerDron - Numer animowanego drona
   */
